                        ...
                        <ul class="flex-column pl-2 nav">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-7" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="inbox.html">VIEW TICKETS</a>
                                        </li>
                                        <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-xl-10">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">CLIENT TICKET</h5>
                                    <div class="card-body">
                                        <form action="addclienttic.php" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="inputPhone" type="phonenumber" placeholder="+910123456789" class="form-control" name="phone">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleFormControlTextarea1">Any Problem Complaint Here...</label>
