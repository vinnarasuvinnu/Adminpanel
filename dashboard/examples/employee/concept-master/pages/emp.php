...
echo '<script>alert("your submission is Successfull");location.href="addemp.php";</script>';

}

function fail($data){
echo '<script>alert("your submission is not Successfull");location.href="addemp.php";</script>';
}
function out($data){
