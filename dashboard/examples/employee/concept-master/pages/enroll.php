                            ...
                            ?>
                               <br>
                                ...
                                if($type==1){
                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                                        <a class="nav-link" href="addprod.php">ADD PRODUCTS</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="viewprod.php">VIEW PRODUCTS</a>
                                                    </li>
                                                    <li class="nav-item">
                                                    ...
                                                    <li class="nav-item">
                                                     ...
                                                     <li class="nav-item">
                                                        <a class="nav-link" href="purchase.php">PURCHSES</a>
                                                    </li>
                                                    <li class="nav-item">
...
<li class="nav-item ">
                                <a class="nav-link" href="http://localhost/Attendance%20and%20Payroll%20System%20PHP/apsystem/admin/"  aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="fab fa-fw fa-wpforms"></i>ATTENDANCE</a>
...
<br>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-3" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="chart-c3.html">SALES HISTORY</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="chart-chartist.html">PRODUCT DETAILS</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="chart-charts.html">TICKETS</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            ?>
                             ...
                             <li class="nav-item ">
                                <a class="nav-link" href="enroll.php"  aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="fab fa-fw fa-wpforms"></i>ENROLLMENT</a>
