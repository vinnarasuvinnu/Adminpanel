                ...
                <div class="row">
                    <div class="col-xl-10">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">REQUIREMENT TICKET</h5>
                                    <div class="card-body">
                                        <form action="addreqtic.php" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleFormControlTextarea1">Any Problem with requirements.....</label>
