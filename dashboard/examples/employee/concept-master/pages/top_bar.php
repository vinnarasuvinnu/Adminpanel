...
John Abraham</span>is now following you
                        ...
                        <li class="nav-item dropdown nav-user">
                            <a class="nav-link nav-user-img" href="logout.php" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../assets/images/avatar-1.jpg" alt="" class="user-avatar-md rounded-circle"></a>
