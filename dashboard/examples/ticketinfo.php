...
<div class="panel-header panel-header-sm">
      ...
      $id=$_GET['id'];
      include('db.php');
      $q1="select * from tickets where pid='$id'";
      ...
      <div class="text-center" style="border: 2px solid black">
        <p><b>Product name</b> : <?php echo $row['pname'] ?> </p>
        <p><b>Product id</b> : <?php echo $row['pid'] ?> </p>
        <p><b>Date of pruchase</b> : <?php echo $row['dateofpurchase'] ?></p>
