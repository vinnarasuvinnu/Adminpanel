...
<div class="panel-header panel-header-sm">
      ...
      <div class="text-center" style="border: 2px solid black">
        <p><b>User name</b> : <?php echo $row['uname'] ?> </p>
        <p><b>User phone number</b> : <?php echo $row['unum'] ?> </p>
        <p><b>User Alternative number</b> : <?php echo $row['ualnum'] ?></p>
        <p><b>User Email</b> : <?php echo $row['uemail'] ?></p>
        <p><b>User Address</b> : <?php echo $row['uaddress'] ?></p>
</div>
